...
export default function SpielbergTitles({ title, spielbergTitles, addToMyMovies }) {
    ...
    <>
      <>
        ...
        <MoviesContainer>
          ...
          <MoviesRow trendingTitles={spielbergTitles} >

            {spielbergTitles.map((movie, index) => (
          ...
          {posterIndex < spielbergTitles.length - 3 && <FaChevronRight style={chevronRightStyle} onClick={transformRight} />}
        </MoviesContainer>
      </>
    </>
  )
